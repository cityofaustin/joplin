# Generated by Django 2.0.8 on 2018-08-28 18:07
...
def add_servicepages(apps, schema_editor):
    ...
    data = [{'slug': 'bat-safety', 'topic': 'healthcare-prevention', 'image': 'curbside-compost', 'contact': 311,
      'title_en': 'Keep yourself safe around bats in Austin', 'title_es': 'Keep yourself safe around bats in Austin',
      'title_vi': 'Keep yourself safe around bats in Austin', 'title_ar': 'Keep yourself safe around bats in Austin',
     ...
     {'slug': 'bulk-item-pickup', 'topic': 'recycling-trash-compost', 'image': 'bulk-items', 'contact': 311,
      ...
      'title_ar': 'كُن على استعداد لجمع العناصر كبيرة الحجم التي يُراد التخلص منها على جانب الرصيف', 'steps_en': [
      ...
      'steps_es': [
          ...
          'Separe los artículos en tres grupos.', ['Metales: incluye electrodomésticos, debe quitarles las puertas',
     ...
     {'slug': 'compost-pickup', 'topic': 'recycling-trash-compost', 'image': 'curbside-compost', 'contact': 311,
      'title_en': 'Get ready for curbside compost pickup', 'title_es': 'Prepárese para la recolección de compost',
     ...
     {'slug': 'get-immunized', 'topic': 'healthcare-prevention', 'image': 'paint', 'contact': 311,
      'title_en': 'Get immunizations for you and your family', 'title_es': 'Get immunizations for you and your family',
      'title_vi': 'Get immunizations for you and your family', 'title_ar': 'Get immunizations for you and your family',
     ...
     {'slug': 'hazardous-waste-dropoff-prototype', 'topic': 'recycling-trash-compost',
      ...
      'title_ar': 'التخلص من النفايات الخطرة المنزلية وغيرها من المواد القابلة للتدوير\\[Prototype\\]', 'steps_en': [
      ...
      'meta_tags': None},
     {'slug': 'hazardous-waste-dropoff', 'topic': 'recycling-trash-compost', 'image': 'household-hazardous-waste',
     ...
     {'slug': 'pickup-free-paint', 'topic': 'recycling-trash-compost', 'image': 'paint', 'contact': 311,
      ...
      'dynamic_content': [{'type': 'map', 'description_en': 'Hazardous Waste Dropoff Center',
                           ...
                           'description_vi': 'Ghé thăm Cửa Hàng Tái Dụng tại Trung Tâm Tái Chế & Tái Dụng',
                           'description_ar': 'تفضل بزيارة مستودع إعادة الاستخدام في مركز إعادة التدوير وإعادة الاستخدام',
                           'location': 'Recycle & Reuse Drop-off Center'}], 'meta_title_en': 'Pick up free paint',
     ...
     {'slug': 'trash-recycling-pickup', 'topic': 'recycling-trash-compost', 'image': 'curbside-pickup', 'contact': 311,
