...
from pages.official_documents_page.fixtures.helpers.create_fixture import create_fixture as create_document_fixture
...
def copy_official_document_page_documents():
    """
    iterates through OfficialDocumentPageDocuments and copies the data into the OfficialDocumentPage model
    """
    ...
    for page in all_document_page_documents:
        ...
        while OfficialDocumentPage.objects.filter(slug=candidate_slug).exists():
        ...
        page_data = {
            ...
            "slug": candidate_slug,
            "add_departments": {
                "departments": [Department.objects.get(name='Office of Police Oversight')], # hard coding this since all
            },
    ...
    print(OfficialDocumentPage.objects.count() == OfficialDocumentPageDocument.objects.count())
