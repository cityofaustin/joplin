...
from pages.official_documents_collection.fixtures.test_cases import kitchen_sink as kitchen_sink_official_documents_collection


# A "kitchen sink" official documents page
def kitchen_sink():
    official_documents_collection = kitchen_sink_official_documents_collection.kitchen_sink()
    ...
    file_content_es = str("Yo soy file content [es]").encode('utf-8')
    ...
    page_data = {
        ...
        "add_official_document_collection": {
            "official_document_collection": [official_documents_collection],
        },
    }
