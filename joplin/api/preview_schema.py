...
class PreviewRichTextFieldType(Scalar):
    """
...
def convert_rich_text_field(field, registry=None):
    return PreviewRichTextFieldType(
...
class PreviewStreamFieldType(Scalar):
    @staticmethod
...
def convert_stream_field(field, registry=None):
    return PreviewStreamFieldType(description=field.help_text, required=not field.null)
