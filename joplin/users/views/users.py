# almost verbatim from wagtail, except for a change on permissions to view users
...
# wagtail has this set as @any_permission_required(add_user_perm, change_user_perm, delete_user_perm)
# however, we want editors & moderators to be able to see users but not add, change or delete - chia
